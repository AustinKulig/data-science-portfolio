...
class DBConnection:
    data_path = "/Bots/LinkedIn Data Scraper/"  # database file path
    conn = sqlite3.connect(data_path + 'linkedin_data.db3')  # name of database
    cur = conn.cursor()
    ...
    def initialize(self):
        """Check if DB exists, create table if it doesn't
        """
